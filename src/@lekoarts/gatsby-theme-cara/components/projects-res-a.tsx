...
import ProjectsResearchActivity from '../sections/projects-research-activity.mdx'
...
const ProjectsResearchA: React.FC<{ offset: number; factor?: number }> = ({ offset, factor = 2 }) => (
  <div>
    <Divider
...
export default ProjectsResearchA
