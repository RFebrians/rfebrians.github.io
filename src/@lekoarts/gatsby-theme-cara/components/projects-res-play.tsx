...
import ProjectsResearchPlayground from '../sections/projects-research-playground.mdx'
...
const ProjectsResearchP: React.FC<{ offset: number; factor?: number }> = ({ offset, factor = 2 }) => (
  <div>
    <Divider
...
export default ProjectsResearchP
